...
the ordering of the pins TBD based on layout} -180 -890 0 0 0.4 0.4 {}
N 180 480 320 480 {
lab=VGND}
N 180 -510 320 -510 {
lab=VAPWR}
...
N 680 440 750 440 {
lab=reg[53],reg[45],reg[37],reg[15],reg[7]}
N 680 -270 750 -270 {
lab=reg[112],reg[113]}
N 680 -250 750 -250 {
lab=reg[105]}
...
C {devices/iopin.sym} 180 -410 2 0 {name=p4 lab=bus[5:1]}
...
C {devices/ipin.sym} -480 -300 0 0 {name=p1 lab=ena}
...
C {devices/lab_pin.sym} 750 440 0 1 {name=p44 sig_type=std_logic lab=reg[53],reg[45],reg[37],reg[15],reg[7]}
C {devices/lab_pin.sym} 750 -250 0 1 {name=p45 sig_type=std_logic lab=reg[105]}
C {devices/lab_pin.sym} 750 -270 0 1 {name=p46 sig_type=std_logic lab=reg[112],reg[113]}
C {devices/lab_pin.sym} 750 -270 0 1 {name=p47 sig_type=std_logic lab=reg[112],reg[113]}
...
C {devices/lab_pin.sym} 750 -150 0 1 {name=p52 sig_type=std_logic lab=reg[148],reg[156]}
