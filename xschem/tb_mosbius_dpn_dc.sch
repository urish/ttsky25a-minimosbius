...
S {}
E {}
L 4 1280 -1500 1280 -820 {}
L 4 1280 -1500 2380 -1500 {}
L 4 1280 -820 2380 -820 {}
L 4 2380 -1500 2380 -820 {}
T {REFERENCE DIFF PAIR} 1310 -1470 0 0 0.4 0.4 {}
N 100 100 100 120 {
lab=VAPWR}
N 200 100 200 120 {
lab=VDPWR}
...
lab=VDPWR}
N 1840 -1190 1860 -1190 {
lab=VAPWR}
N 1840 -980 1840 -960 {
lab=GND}
N 1840 -980 1860 -980 {
lab=GND}
N 1440 -1090 1460 -1090 {
lab=VDPWR}
...
N 1440 -970 1440 -950 {
lab=GND}
N 1680 -1030 1680 -990 {
lab=GND}
N 1660 -1030 1680 -1030 {
lab=GND}
N 1660 -1010 1680 -1010 {
lab=GND}
N 380 100 380 120 {
lab=ibias_ref}
N 1440 -1050 1460 -1050 {
lab=ibias_ref}
N 1840 -1010 1860 -1010 {
lab=GND}
N 1840 -1010 1840 -980 {
lab=GND}
N 1800 -1030 1860 -1030 {
lab=vs1,vs0}
N 1820 -1120 1860 -1120 {
lab=vinp}
N 1820 -1100 1860 -1100 {
lab=vinm}
N 1800 -1050 1860 -1050 {
lab=ibias_ref}
N -360 -1150 -200 -1150 {
...
N 1100 120 1100 160 {
lab=voutp}
N 2280 -1330 2280 -1310 {
lab=VAPWR}
N 2160 -1330 2160 -1310 {
lab=VAPWR}
N 2060 -1120 2160 -1120 {
lab=#net4}
N 2160 -1250 2160 -1120 {
lab=#net4}
N 2060 -1100 2280 -1100 {
lab=#net5}
N 2280 -1250 2280 -1100 {
lab=#net5}
N 660 -1010 700 -1010 {
lab=GND}
N 700 -1010 700 -990 {
...
C {devices/vsource.sym} 520 310 0 0 {name=VSIG value=0}
...
.control
   ...
   plot mosb_gm_200u base_gm_200u mosb_gm_400u base_gm_400u mosb_gm_600u base_gm_600u mosb_gm_800u base_gm_800u
.endc
"}
...
C {devices/lab_pin.sym} 1840 -1190 0 0 {name=p13 sig_type=std_logic lab=VAPWR}
C {devices/lab_pin.sym} 1840 -1170 0 0 {name=p23 sig_type=std_logic lab=VDPWR}
C {devices/gnd.sym} 1840 -960 0 0 {name=l7 lab=GND}
C {mirror_n.sym} 1510 -1050 0 0 {name=x3}
C {devices/lab_pin.sym} 1440 -1110 0 0 {name=p26 sig_type=std_logic lab=VAPWR}
C {devices/lab_pin.sym} 1440 -1090 0 0 {name=p29 sig_type=std_logic lab=VDPWR}
C {devices/gnd.sym} 1440 -900 0 0 {name=l8 lab=GND}
C {devices/gnd.sym} 1680 -990 0 0 {name=l11 lab=GND}
...
C {devices/lab_pin.sym} 1440 -1050 0 0 {name=p31 sig_type=std_logic lab=ibias_ref}
C {devices/lab_pin.sym} 1820 -1120 2 1 {name=p12 sig_type=std_logic lab=vinp}
C {devices/lab_pin.sym} 1820 -1100 2 1 {name=p32 sig_type=std_logic lab=vinm}
C {devices/lab_wire.sym} 1820 -1030 0 0 {name=p35 sig_type=std_logic lab=vs1,vs0}
C {devices/lab_wire.sym} 1820 -1050 0 0 {name=p36 sig_type=std_logic lab=ibias_ref}
...
C {diff_n.sym} 1960 -1070 0 0 {name=x4}
C {devices/ammeter.sym} 2160 -1280 0 0 {name=Vmeasp_ref}
C {devices/ammeter.sym} 2280 -1280 0 0 {name=Vmeasm_ref}
C {devices/lab_pin.sym} 2160 -1330 1 0 {name=p33 sig_type=std_logic lab=VAPWR}
C {devices/lab_pin.sym} 2280 -1330 1 0 {name=p34 sig_type=std_logic lab=VAPWR}
...
C {devices/vsource.sym} 1000 380 0 0 {name=VS1 value=0}
C {devices/gnd.sym} 1000 410 0 0 {name=l17 lab=GND}
C {devices/lab_pin.sym} 1000 330 1 0 {name=p62 sig_type=std_logic lab=vs1}
