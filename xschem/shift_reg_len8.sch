...
C {devices/opin.sym} 1370 130 0 0 {name=p4 lab=data[7:0]}
...
C {devices/lab_pin.sym} 2820 -240 0 0 {name=p38 sig_type=std_logic lab=rstb}
C {devices/lab_pin.sym} 2820 -280 0 0 {name=p39 sig_type=std_logic lab=clk}
...
C {devices/lab_wire.sym} 2750 -280 0 0 {name=p48 sig_type=std_logic lab=reg[6]}
...
C {devices/opin.sym} 3100 -280 0 0 {name=p6 lab=out}
...
C {sky130_stdcells/and2_1.sym} 1260 130 0 0 {name=x10[7:0] VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
...
C {sky130_stdcells/dfrtp_1.sym} 2940 -260 0 0 {name=x8 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/iopin.sym} 240 -80 0 1 {name=p12 lab=VGND}
C {sky130_stdcells/clkinv_1.sym} 650 130 0 0 {name=x9 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/iopin.sym} 240 -280 0 1 {name=p11 lab=VPB}
