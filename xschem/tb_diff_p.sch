...
C {devices/isource.sym} -1060 -370 2 0 {name=I0 value=100u}
C {devices/gnd.sym} -1000 -400 0 0 {name=l4 lab=GND}
C {devices/lab_pin.sym} -1060 -280 0 0 {name=p8 sig_type=std_logic lab=vbias}
C {devices/lab_pin.sym} -140 -230 0 0 {name=p9 sig_type=std_logic lab=vbias}
C {devices/ammeter.sym} 190 -300 3 0 {name=Vmeasp}
C {devices/ammeter.sym} 270 -220 3 0 {name=Vmeasn}
...
C {mirror_p.sym} -820 -300 0 0 {name=x1}
C {diff_p.sym} -10 -250 0 0 {name=x2}
C {devices/gnd.sym} 340 -200 0 0 {name=l12 lab=GND}
C {devices/gnd.sym} -640 -240 0 0 {name=l14 lab=GND}
